...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'FN:√SINULL√\n' // Nama Lu
            + 'ORG:#Bosbot;\n' // Nama Kontak Owner
            + 'TEL;type=CELL;type=VOICE;waid=16285741517504\n' //
            + 'END:VCARD'
prefix = "#"
blocked = []
...
async function starts() {
	...
	anker.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = [bocah mbedud]
			const nomorOwner = [0857-4151-7504]
			...
			const isOwner = ownerNumber.includes(sender)
                        ...
                        const NomerOwner = '628574151750411@s.whatsapp.net'
                        const isEventon = isGroup ? event.includes(from) : false
                        const isRegister = checkRegisteredUser(sender)
                        pushname = sinull.contacts[sender] != undefined ? sinull.contacts[sender].vname || sinull.contacts[sender].notify : undefined
